...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_6MTdMzFz3AOOew",
      key_secret: "I48efeuCBq1QRot4bOdIfjGz",
  ...
  return (
    <Layout >
      <div className="h-auto bg-gray-100 pt-5 mb-[60%] " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
